...
class Stock(models.Model):
    ts_code = models.CharField(max_length=10, blank=False, primary_key=True)
...
def getModek(db_table):
    class DayilyMetaclass(models.base.ModelBase):
        def __new__(cls, name,bases,attrs):
            name += db_table
            return models.base.ModelBase.__new__(cls,name,bases,attrs)

    class Dayily(models.Model):
        __metaclass__ = DayilyMetaclass
...
class StockInfos(models.Model):
    ...
    class Meta:
        verbose_name_plural = "StockInfos"
        db_table = 'StockInfos'


class Industry(models.Model):
    industrys = models.CharField(max_length=20, blank=True, null=True, verbose_name="行业")
